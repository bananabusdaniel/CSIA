...
public class BollywoodClass {
    ...
    private String classSong = "not set yet";
    private String classDate = "not set yet";
   // We will be using the class, Song, in this class as well
    public BollywoodClass(){
    
    }
    
    public BollywoodClass(String className, String classLocation, String classDate, String classSong, String inPersonOrZoom){
        this.className = className;
        this.classLocation = classLocation;
        this.classDate = classDate;
        this.classSong = classSong;
